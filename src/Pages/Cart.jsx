...
function ExpressPaymentIcons() {
  return (
    <StyledWrapper>
      <div className="expres-payment-options">
        <button type="button">
          <svg
...
const StyledWrapper = styled.div`
  ...
  .expres-payment-options {
    display: grid;
    grid-template-columns: 1fr 1fr 1fr;
    gap: 10px;
  }

  .expres-payment-options button {
    height: 50px;
    width: auto;
    background: #f2f2f2;
    padding: 0;
  ...
  .expres-payment-options button:hover {
    transform: scale(1.05);
  }

  .expres-payment-options button svg {
    height: 18px;
  }

  .expres-payment-options button:last-child svg {
    height: 22px;
  }
